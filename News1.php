...
class Navigation {
    ...
    public function render() {
        ...
        echo '<li class="menubutton"><a href="#"><img src="images/menuwhite.png" alt="Menu" height="24" width="24"></a></li>';
        echo '</ul>';
        echo '</nav>';
    }
}
...
class Page {
    ...
    public function renderContent() {
        ...
        echo '<h2>MG5</h2>';
        echo '<div class="singlepost_thumbnail"><img src="images/foto1-news1" alt="foto1-news1"></div>';
        echo '<p>Leading the charge on the electric estate front was the MG 5...</p>';
